...
Scenario: Verify the add to cart functionality of the Mackbook product2
When the user click on mackbook product available on the page
Then the title of the web page should contains "Mobile"
And verifies the Add to cart text should contains "0 item(s) - $0.00"
When the user add the quantity as "1"
And click on the add to cart button
Then then the add to cart text should contains "  1 item(s) - $601.00"